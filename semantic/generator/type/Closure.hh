...
namespace semantic {
	...
	private : 
	    ...
	    Closure (const lexing::Word & loc, const std::vector <Generator> & innerType, const std::vector<std::string> & names, uint position);

	public : 


	    static Generator init (const lexing::Word & loc, const std::vector <Generator> & innerType, const std::vector<std::string> & names, uint position);
