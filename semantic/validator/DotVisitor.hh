...
namespace semantic {
	...
	public :
	     ...
	     */
	    generator::Generator validateClass (const syntax::Binary & expression, const generator::Generator & left, std::list <std::string> & errors);
	...
	private :
	     ...
	     */
	    void error (const syntax::Binary & expression, const generator::Generator & left, const std::string & right, std::list <std::string> & errors);
