...
namespace semantic {
	...
	public :
	     ...
	     */
	    generator::Generator validateClass (const syntax::Binary & expression, const generator::Generator & left, std::list <Ymir::Error::ErrorMsg> & errors);
	...
	private :
	     ...
	     */
	    void error (const syntax::Binary & expression, const generator::Generator & left, const std::string & right, std::list <Ymir::Error::ErrorMsg> & errors);
