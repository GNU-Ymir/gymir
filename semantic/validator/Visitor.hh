...
namespace semantic {
	...
	private :
	    ...
	    std::map <std::string, generator::Generator> _cache_type_vars;

	    std::map <std::string, generator::Generator> _cache_value_vars;

	    std::list <bool> _fast_validation;
	...
	public :
	    ...
	    bool inFastValidation ();
	    
	    syntax::Expression createVarFromPath (const lexing::Word & loc, const std::vector <std::string> & path);

	    generator::Generator createTypeFromPath (const lexing::Word & loc, const std::vector <std::string> & path, bool cachable = true);
	    
	    generator::Generator createValueFromPath (const lexing::Word & loc, const std::vector <std::string> & path, bool cachable = true);	    
