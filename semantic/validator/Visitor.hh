...
namespace semantic {
	...
	class Visitor {
	    ...
	    /** All the protos generated by template specialization */
	    std::vector <generator::FrameProto> _templateProtos;
	...
	public :
	     ...
	     */
	    bool insertTemplateProto (const generator::FrameProto & proto);
